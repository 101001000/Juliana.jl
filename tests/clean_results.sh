find rodinia/julia_cuda/ -type f -name "*.json" -exec rm -f {} +
find rodinia/julia_gen/ -type f -name "*.json" -exec rm -f {} +
find rodinia/common/julia/csv -type f -name "*.csv" -exec rm -f {} +
